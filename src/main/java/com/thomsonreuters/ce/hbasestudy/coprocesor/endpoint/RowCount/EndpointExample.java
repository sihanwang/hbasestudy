package com.thomsonreuters.ce.hbasestudy.coprocesor.endpoint.RowCount;
...
import com.thomsonreuters.ce.hbasestudy.coprocesor.endpoint.RowCount.generated.RowCounterProtos;
import com.thomsonreuters.ce.hbasestudy.coprocesor.regionobserver.RegionObserverExample;
...
public class EndpointExample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (String cf : new String[]{"colfam1", "colfam2"}) {
      HColumnDescriptor coldef = new HColumnDescriptor(cf);
      coldef.setMaxVersions(1);
      desc.addFamily(coldef);
    }
    
    desc.setValue("COPROCESSOR$1", "hdfs://jing-server-3:8020/hbase/lib/coprocessor.jar" +
	"|" + RowCountEndpoint.class.getCanonicalName() +
      ...
      Map<byte[], Long> results = table.coprocessorService(
        ...
        new Batch.Call<RowCounterProtos.RowCountService, Long>() { // co EndpointExample-3-Batch Create an anonymous class to be sent to all region servers.
          ...
          throws IOException {
            ...
            counter.getCellCount(null, request, rpcCallback); // co EndpointExample-4-Call The call() method is executing the endpoint functions.
