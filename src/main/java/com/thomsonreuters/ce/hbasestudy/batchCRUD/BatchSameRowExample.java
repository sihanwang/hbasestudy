package com.thomsonreuters.ce.hbasestudy.batchCRUD;
...
public class BatchSameRowExample {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    delete.addColumns(COLFAM1, QUAL1, 1L); // co BatchSameRowExample-1-AddDelete Delete the row that was just put above.
    batch.add(delete);
