package com.thomsonreuters.ce.hbasestudy.mapreduce;
...
//需要将所有用到的hbase的jar打包到一个jar中，另一个方法是在每一天hadoop的服务器上配置hbase的jar
//hadoop com.thomsonreuters.ce.hbasestudy.mapreduce.ImportFromFile -t testtable -i importfromfiletotable/test-data.txt -c data:json
//
